...
let AiController = class AiController {
    ...
    async generateWorkflow(req, body) {
        return this.aiService.generateCampaignWorkflow(body.prompt);
    }
    async generateSocialContent(body) {
...
__decorate([
    (0, common_1.Post)('campaign/workflow'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], AiController.prototype, "generateWorkflow", null);
__decorate([
    (0, common_1.Post)('social-content'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
