...
exports.ContactsModule = ContactsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [contacts_service_1.ContactsService, segmentation_service_1.SegmentationService],
        exports: [contacts_service_1.ContactsService, segmentation_service_1.SegmentationService],
    })
], ContactsModule);
